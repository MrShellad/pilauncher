...
import type { TerracottaLogEntry } from '../../types';
...
export const LogViewer: React.FC<LogViewerProps> = ({ logs, lastError }) => {
  return (
    <div className="ore-multiplayer-card flex-1 min-h-0 h-full">
      <div className="ore-multiplayer-card-heading shrink-0">
        <div>
      ...
      <div className="ore-multiplayer-log-list">
        ...
        {logs.length === 0 && !lastError ? (
          <div className="ore-multiplayer-empty-state">
            ...
            <div>Terracotta 启动后，日志会实时显示在这里。</div>
          </div>
        ) : (
          logs
            .slice()
