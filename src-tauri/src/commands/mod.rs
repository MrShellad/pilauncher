...
pub fn register<R: Runtime>(builder: Builder<R>) -> Builder<R> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        instance::resource_cmd::update_mod_platform_matches_batch,
        ...
        instance::resource_cmd::ensure_offline_resource_icon,
        ...
        modpack_cmd::check_modpack_update,
        modpack_cmd::execute_modpack_upgrade,
        modpack_cmd::rollback_modpack_upgrade,
